...
/**
 * Average Rating Stars Elementor widget.
 *
 * Displays the average rating as stars for a post.
 */
class AverageRatingStars extends WidgetBase {
	...
	public function get_name() {
		return 'rtrs-average-rating-stars';
	}
	...
	public function get_title() {
		return esc_html__( 'Average Rating Stars', 'review-schema' );
	}
	...
	private function register_style_controls() {
		...
		$this->add_star_style_controls(
			'star',
			'{{WRAPPER}} .rtrs .shortcode-rtrs-rating-icon i',
			[
				'empty_color'        => true,
				'gap'                => true,
				'alignment'          => true,
				'alignment_selector' => '{{WRAPPER}} .rtrs .shortcode-rtrs-rating-icon',
			]
		);
	...
	protected function render() {
		...
		$output = ShortcodesInit::average_stars( $atts );

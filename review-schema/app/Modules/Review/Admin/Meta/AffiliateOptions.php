...
class AffiliateOptions {
		...
		$section_affiliate = [
			...
			[
				...
				'options' => [
					[
						'value' => 'two',
						'img'   => RTRS_URL . '/assets/imgs/affiliate/affiliate-layout-2.png',
					],
					[
						'value'  => 'one',
						'img'    => RTRS_URL . '/assets/imgs/affiliate/affiliate-layout-1.png',
						'is_pro' => true,
					],
					[
						'value'  => 'three',
						'img'    => RTRS_URL . '/assets/imgs/affiliate/affiliate-layout-3.png',
						'is_pro' => true,
					],
					// array(
					// 'value' => 'four',
			...
			[
				...
				'id'     => 'open_in_new_tab',
				'label'  => esc_html__( 'Button url open in a new tab?', 'review-schema' ),
				'option' => esc_html__( 'Enable', 'review-schema' ),
			],
			[
				'type'  => 'text',
	...
	function sectionSchemaFields() {
		...
		$section_schema = [
			...
			[
				...
				'type'        => 'float',
				'holderClass' => 'rtrs-snippet-custom',
				'label'       => esc_html__( 'Review rating average value', 'review-schema' ),
				'recommended' => true,
			...
			[
				...
				'class'       => 'rtrs-date',
				'desc'        => sprintf(
					/* translators: %s: example date in Y-m-d H:i:s format */
	...
	function prosCons() {
		return apply_filters( 'rtrs_pros_cons', [ '' ] );
	}
}
